...
## Status
- **Font Asset:** `Inter-Regular.ttf` (SIL OFL) downloaded from Google Fonts (`fonts.gstatic.com`) and stored at `dotnet/Vello.Tests/TestAssets/fonts/Inter-Regular.ttf`. Attribution lives next to the binary (`Inter-Regular-OFL.txt`).
